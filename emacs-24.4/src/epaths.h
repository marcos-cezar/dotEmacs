...
*/
#define PATH_LOADSEARCH "/usr/local/share/emacs/24.4/lisp"
...
*/
#define PATH_SITELOADSEARCH "/usr/local/share/emacs/24.4/site-lisp:/usr/local/share/emacs/site-lisp"
...
*/
#define PATH_DUMPLOADSEARCH "/home/marcos/emacs-24.4/lisp"
...
#define PATH_EXEC "/usr/local/libexec/emacs/24.4/x86_64-unknown-linux-gnu"

/* Where Emacs should look for its architecture-independent data
   files, like the NEWS file.  The lisp variable data-directory
   is set to this value.  */
#define PATH_DATA "/usr/local/share/emacs/24.4/etc"
...
#define PATH_DOC "/usr/local/share/emacs/24.4/etc"
